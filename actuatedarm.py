...
class ActuatedArm(Sofa.Prefab):
    ...
    def init(self):
        ...
        loader = self.addObject('MeshOBJLoader', name='loader_noodle', triangulate=True, filename='Demos/mx_simulation/Body8_lowres_mm_2.obj')
        noodleVisu = self.addChild('noodleVisu')
        noodleVisu.addObject('OglModel', name='Visual', src='@../loader_noodle', color="blue")
        noodleVisu.addObject('RigidMapping')
