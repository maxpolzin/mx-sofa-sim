...
class CubeBot(Sofa.Prefab):
    ...
    def init(self):
        ...
        cube_red = Cube(self, totalMass=500, name="Red", color=[1., 0., 0., 1.], translation=[1.25, 15.0, 0.0], rotation=[0.0, 90.0, 0.0], uniformScale=1.0, isAStaticObject=False)    
        ...
        articulationCenter.addObject('ArticulationCenter', posOnParent=[0, 0., 1.95], parentIndex=0, childIndex=0, posOnChild=[0., 0., 0.])
        ...
        cube_blue = Cube(angle, name="Blue", totalMass=500, color=[0., 0., 1., 1.], uniformScale=0.9, isAStaticObject=False)
